  ...
  return (
    <div
      ...
      style={{
        height: "100vh",
        minHeight: "100vh",
        overflow: "hidden", // IMPORTANT: yaha se body scroll band
        position: "relative",
      }}
    >
                ...
                >
                  ...
                  <div style={{ position: "relative", zIndex: 2 }}>
                    <p
                      style={{
                        marginTop: "0.2rem",
                        maxHeight: "260px", // inner scroll ok
                        overflowY: "auto",
                        paddingRight: "0.4rem",
                        fontSize: "0.98rem",
                        lineHeight: 1.7,
          ...
          {slide === 6 && (
            ...
            >
              <motion.div
                ...
                style={{ maxWidth: "640px" }}
              >
                {/* text sirf tab jab envelope close ho */}
                {!envelopeOpened && (
                  <>
                    <motion.p
                      variants={fadeUp}
      ...
      {/* FOOTER ko fixed kar diya – height increase nahi karega */}
      <footer
        className="footer"
        style={{
          position: "fixed",
