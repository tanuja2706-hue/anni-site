...
export default function Home() {
  ...
  /* GLOBAL – page scroll lock (no page scroll anywhere) */
  useEffect(() => {
            ...
            >
              ...
              >
                ...
                <motion.p
                  ...
                  variants={fadeUp}
                  style={{ marginBottom: "1.1rem", fontSize: "0.95rem" }}
                >
                  Teen cards, ek hi asli surprise…Let&apos;s see how strong
                  your guess is. 😏💕
                </motion.p>
                      ...
                      <div
                        style={{
                          ...
                          background: isWinner
                            ...
                            : "linear-gradient(135deg,#020617,#111827)",
                          boxShadow: isWinner
                            ? "0 20px 45px rgba(236,72,153,0.8)"
            ...
            >
              ...
              >
                <motion.h2
                  variants={fadeUp}
                  style={{
                    fontSize: "clamp(1.9rem, 4.6vw, 2.4rem)",
                    fontWeight: 800,
                    marginBottom: "1rem",
                    color: "#ff8acb",
                  }}
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: "999px",
                        background: "#f973b8",
                        boxShadow: "0 16px 36px rgba(236,72,153,0.55)",
                        color: "#fff",
                        fontWeight: 700,
                        fontSize: "1rem",
                        cursor: "pointer",
            ...
            >
              ...
              >
                <motion.h2
                  variants={fadeUp}
                  style={{
                    fontSize: "clamp(1.9rem, 4.4vw, 2.4rem)",
                    fontWeight: 800,
                    marginBottom: "1.2rem",
                    color: "#a855f7",
                  }}
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: "0 12px 26px rgba(248, 187, 208, 0.35)",
                    cursor: "pointer",
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                ...
                >
                  <motion.div
                    style={{
                      ...
                      alignItems: "center",
                      justifyContent: "center",
                      boxShadow: "0 10px 20px rgba(148,163,184,0.5)",
                      marginBottom: "0.3rem",
                    }}
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    borderRadius: "26px",
                    boxShadow: "0 14px 36px rgba(248,187,208,0.55)",
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    cursor: "pointer",
                    boxShadow: "0 16px 38px rgba(34,197,94,0.58)",
                    display: "block",
                    marginLeft: "auto",
                    marginRight: "auto",
                  }}
                ...
                {!envelopeOpened ? (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: "0 20px 40px rgba(12, 21, 42, 0.9)",
                      position: "relative",
                      cursor: "pointer",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    ...
                    <motion.div
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        boxShadow: "0 12px 28px rgba(248,113,113,0.65)",
                      }}
                      animate={{
                        scale: [1, 1.03, 1],
                        y: [0, -1.5, 0],
